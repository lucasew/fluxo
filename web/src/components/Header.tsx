  ...
  return (
    <div className="navbar bg-base-100 shadow-lg sticky top-0 z-50 px-4">
      <div className="flex-1">
        <Link
          to="/"
          className="btn btn-ghost text-xl font-bold text-primary px-2"
        >
          Fluxo
        </Link>
      </div>
      ...
      <div className="flex-none flex items-center gap-3 md:gap-4">
        ...
        <div className="opacity-80">
          <Suspense
            fallback={
              <div className="w-20 h-8 bg-base-200 rounded animate-pulse"></div>
            }
          >
            <HeaderStats />
          </Suspense>
        ...
        <Link
          to="/add"
          className="btn btn-primary btn-sm md:btn-md btn-circle md:btn-wide md:px-4 md:w-auto"
